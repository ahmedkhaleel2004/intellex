const questions = [
	{
		...
		desc: "This will be used to match you with other users in your country.",
	},
	{
    ...
    {
        title: "Provide a brief description of yourself",
        placeholder: "Enter one descriptive sentence here",
        desc: "This will be used to create your mentor description",
    },
	{
